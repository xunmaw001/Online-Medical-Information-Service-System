  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="学历" class="input" v-if="tableName=='yisheng'">
			...
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoyubeijing" class="input" type="text" placeholder="教育背景">
			   </div>
			 </div> -->
			<el-form-item label="教育背景" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.jiaoyubeijing" autocomplete="off" placeholder="教育背景"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			   <div class="label">毕业学校</div>
			   <div class="input-container">
			     <input v-model="ruleForm.biyexuexiao" class="input" type="text" placeholder="毕业学校">
			   </div>
			 </div> -->
			<el-form-item label="毕业学校" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.biyexuexiao" autocomplete="off" placeholder="毕业学校"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`yisheng` == this.tableName && this.ruleForm.thumbsupnum&&(!this.$validate.isIntNumer(this.ruleForm.thumbsupnum))){
        this.$message.error(`赞应输入整数`);
        return
      }
      if(`yisheng` == this.tableName && this.ruleForm.crazilynum&&(!this.$validate.isIntNumer(this.ruleForm.crazilynum))){
        this.$message.error(`踩应输入整数`);
        return
      }
      if(`yisheng` == this.tableName && this.ruleForm.clicknum&&(!this.$validate.isIntNumer(this.ruleForm.clicknum))){
